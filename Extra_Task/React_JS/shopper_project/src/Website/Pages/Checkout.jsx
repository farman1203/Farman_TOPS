...
const Checkout = () => {
  ...
  const handlePlaceOrder = async () => {
    ...
    if (!billing.name) newErrors.name = true;
                ...
                <div className="p-3 p-lg-5 border">
                  ...
                  <div className="form-group row">
                    <div className="col-md-6">
                      ...
                      <input type="text" className="form-control" id="c_fname" onChange={(e) =>
                  ...
                  <div className="col-md-12">
                    ...
                    <div className="p-3 p-lg-5 border">
                      ...
                      <div className="border p-3 mb-5">
                        <h3 className="h6 mb-0"><a className="d-block" data-toggle="collapse" href="#collapsepaypal" role="button" aria-expanded="false" aria-controls="collapsepaypal">Cash On Delhivery</a></h3>
